            ...
            <ul className="nav nav-pills animation-nav profile-nav gap-2 gap-lg-3 flex-grow-1" role="tablist">
                ...
                <li className="nav-item">
                    <Link
                        ...
                        <i className="ri-file-list-3-line d-inline-block d-md-none" />
                ...
                <li className="nav-item">
                    <Link
                        ...
                        <i className="ri-price-tag-3-line d-inline-block d-md-none" />
                ...
                <li className="nav-item">
                    <Link
                        ...
                        <i className="ri-shopping-bag-3-line d-inline-block d-md-none" />
                ...
                <li className="nav-item">
                    <Link
                        ...
                        <i className="ri-bank-card-2-line d-inline-block d-md-none" />
