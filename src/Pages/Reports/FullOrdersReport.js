...
const FullOrdersReport = () => {
    ...
    const { primaryColor, apiHeaderJson, apiURL, statusOptions, selectStyle, selectTheme } = useContext(ConfigContext)
    ...
    const getData = async () => {
        try {
            setLoading(true)
            const response = await axios.get(`${apiURL}Reports/AllSalesmanOrderReport`, {
                headers,
                params: {
                    keyword,
                    page,
            ...
            <div className="main-content">
                <div className="page-content">
                    <div className="container-fluid">
                        <PageTitle title="All Orders" primary="Reports" />
                                        ...
                                        <div className="row mb-4 g-3 align-items-center">
                                            ...
                                            <div className="col-lg-3 col-md-6 col-12 d-flex gap-3 flex-lg-nowrap flex-wrap">
                                                <button
                                                    ...
                                                    disabled={!keyword && dateRange.length === 0 && !selectedStatus}
                                                >
                                                    Filter
                                                    ...
                                                    {loading ? (
                                                        ...
                                                        data.map((row) => (
                                                            <tr key={row.business_order_id} className="text-center">
                                                                ...
                                                                <td className='text-success fw-bold'>AED {parseFloat(row.corrected_grand_total)?.toFixed(2)}</td>
                                                                <td>
